...
%% item macro
%   <year> <item> <short description> <url>
\newcommand{\cvitem}[3]{\item[#1] \textbf{#2} \\ \textsl{#3}}
\newcommand{\cvitemurl}[4]{\item[#1] \textbf{#2} \\ \textsl{#3} \\ \url{#4}}
